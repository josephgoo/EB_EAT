...
%     parfor i=1:N
    for i=1:N
        ...
        thisLeakageEC=leakageEC(parameters.names,p_full);
        ...
        [results(i).upperBound,results(i).debugInfo] = getKeyRate(thisProtocolDescription,thisChannelModel,thisLeakageEC,solverOptions,p_full,parameters.names);
...
function rate = getKeyRate_wrapper(names,p_full,protocolDescription,channelModel,leakageEC,solverOptions)
    ...
    thisLeakageEC=leakageEC(names,p_full);
    ...
    [upperBound,~] = getKeyRate(thisProtocolDescription,thisChannelModel,thisLeakageEC,solverOptions,p_full,names);
